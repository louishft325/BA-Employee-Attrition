...
# Sample 10% of the train dataset #TODO: Remove
...
```{r}
# Check the structure of the dataset to confirm column names #TODO: Do we need this?
str(train)
...
# Remove redundant features - check later if we want this #TODO: Remove
